...
export function ProdutosRelacionados({
  ...
  return (
    <div className="my-8">
      ...
      {/* Layout Mobile - Lista Minimalista */}
          ...
          return (
            ...
            >
              ...
              <button
                ...
                aria-label={isSelected ? 'Desmarcar produto' : 'Marcar produto'}
              >
                {isSelected && <Check className="h-4 w-4 text-black" strokeWidth={3} />}
              </button>

              {/* Informações do produto */}
              <Link href={`/produto/${produto.slug}`} className="min-w-0 flex-1">
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  {produto.desconto_percentual > 0 && (
                    <span className={`rounded ${descontoColors.bg} px-1.5 py-0.5 text-xs font-semibold ${descontoColors.text}`}>
            ...
            >
              <CardContent className="p-4">
                ...
                <div className="mb-3 flex items-start justify-between">
                  ...
                  {/* Badge de desconto */}
                  {produto.desconto_percentual > 0 && (
                    <div className={`flex items-center gap-1 rounded ${descontoColors.bg} border ${descontoColors.border} px-2 py-1 text-xs font-semibold ${descontoColors.text}`}>
                ...
                <Link href={`/produto/${produto.slug}`} className="block">
                  ...
                  {/* Nome */}
                  <h3 className="mt-3 line-clamp-2 text-sm font-medium text-white hover:text-[var(--brand-yellow)]">
                    {produto.nome}
                  </h3>
