    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // Mobile: bottom sheet
          'max-sm:inset-x-0 max-sm:bottom-0 max-sm:top-auto max-sm:max-h-[90vh] max-sm:rounded-t-2xl max-sm:border-t max-sm:border-[#1f1f1f] max-sm:shadow-[0_-4px_60px_rgba(0,0,0,0.8)]',
