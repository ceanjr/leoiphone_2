-- Migration: Create configuracoes_taxas table (VERSÃO SIMPLIFICADA)
...
-- Note: Assumindo que as rotas /admin/* já estão protegidas
CREATE POLICY "Usuários autenticados podem modificar"
  ON configuracoes_taxas
  FOR ALL
