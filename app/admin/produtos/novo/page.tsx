...
import { createProduto, getCategorias } from '../actions'
...
export default function NovoProdutoPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const result = await createProduto(formData as ProdutoFormData)
  ...
  return (
    <div className="flex flex-col gap-4 p-4 md:gap-6 md:p-6">
        <div className="flex items-center gap-3 md:gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold text-white md:text-2xl">Cadastrar Produto</h2>
            <p className="text-xs text-zinc-400 md:text-sm">Preencha os dados do iPhone</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardHeader>
            ...
            <CardDescription>Preencha os dados do iPhone</CardDescription>
          </CardHeader>
